...
const features = [
  ...
  {
    icon: "/div (1).svg",
    title: "Realistic, Private Simulations",
    description:
  ...
  <section className="w-full bg-[#fffcf1] py-[81px] px-6 md:px-[104px]">
    <div className="flex flex-col items-center gap-[55px] max-w-[1440px] mx-auto">
      <h2 className="font-medium text-[#111] text-2xl md:text-[34px] text-center max-w-4xl">
        PowerRoom gives you on-demand, voice-activated practice rooms built for
        real workplace pressure so you can speak with confidence when it
        matters most.
      </h2>
