  ...
  <section className="w-full bg-white py-20 px-6 md:px-[282px] text-center">
    <div className="flex flex-col items-center gap-8 max-w-[1440px] mx-auto">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
        Trusted by senior leaders shaping the future.
      </h2>
      ...
      <div className="w-full max-w-3xl bg-[#fffdf6] rounded-3xl p-8 md:p-12 text-center shadow-sm">
        <blockquote className="text-lg md:text-xl text-gray-800 leading-relaxed italic">
          “Before a major board presentation, I ran the Executive Presence Room twice. 
          The real meeting was the calmest I’ve ever felt—and the board approved our 
          expansion plan on the spot.”
        </blockquote>

        {/* Author Info */}
        <div className="mt-8 flex flex-col items-center gap-3">
          <img
            src="/ellipse-1-2.png" // Replace with actual image path
            alt="VP of Operations"
            className="w-16 h-16 rounded-full object-cover border-2 border-white shadow-md"
          />
          <div>
            <p className="font-semibold text-gray-900">VP of Operations</p>
            <p className="text-sm text-gray-600">Global Finance</p>
          </div>
        </div>
